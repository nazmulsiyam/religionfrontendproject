...
function CheckmarkIcon($$anchor, $$props) {
  ...
  var div = root();
  template_effect(() => {
    set_style(div, "--primary", primary());
    set_style(div, "--secondary", secondary());
  });
  append($$anchor, div);
...
function ToastIcon($$anchor, $$props) {
  ...
  const icon = mutable_state();
  const iconTheme = mutable_state();
    ...
    var alternate_2 = ($$anchor2) => {
      ...
      var node_1 = first_child(fragment_1);
      {
        var consequent_1 = ($$anchor3) => {
          ...
          component(node_2, () => get(icon), ($$anchor4, $$component) => {
            $$component($$anchor4, {});
          });
        ...
        var alternate_1 = ($$anchor3) => {
          ...
          var node_3 = first_child(fragment_3);
          {
            var consequent_4 = ($$anchor4) => {
              ...
              LoaderIcon_default(node_4, spread_props(() => get(iconTheme)));
                ...
                var consequent_3 = ($$anchor5) => {
                  ...
                  var node_6 = child(div_2);
                  {
                    var consequent_2 = ($$anchor6) => {
                      ...
                      ErrorIcon_default(node_7, spread_props(() => get(iconTheme)));
                      append($$anchor6, fragment_4);
                    };
                    var alternate = ($$anchor6) => {
                      var fragment_5 = comment();
                      var node_8 = first_child(fragment_5);
                      CheckmarkIcon_default(node_8, spread_props(() => get(iconTheme)));
...
function ToastMessage($$anchor, $$props) {
  ...
  reset(div);
  template_effect(() => attributes = set_attributes(div, attributes, { class: "message", ...toast2().ariaProps }, "s-edRjvNfbHe5t"));
  append($$anchor, div);
  return pop({ ...legacy_api() });
}
if (import.meta.hot) {
...
function ToastBar($$anchor, $$props) {
  ...
  let factor = mutable_state();
  let animation = mutable_state();
  legacy_pre_effect(
  ...
  reset(div);
  template_effect(() => {
    set_class(div, `base ${(toast2().height ? get(animation) : "transparent") ?? ""} ${toast2().className || ""} s-FRPej9arxh-4`);
    set_attribute(div, "style", `${style() ?? ""}; ${toast2().style ?? ""}`);
    set_style(div, "--factor", get(factor));
  });
  append($$anchor, div);
  return pop({ ...legacy_api() });
}
...
function ToastWrapper($$anchor, $$props) {
  ...
  template_effect(
    ($0) => {
      toggle_class(div, "active", toast2().visible);
      toggle_class(div, "transition", $0);
      set_style(div, "--factor", get(factor));
      set_style(div, "--offset", toast2().offset);
      set_style(div, "top", get(top));
      set_style(div, "bottom", get(bottom));
      set_style(div, "justify-content", get(justifyContent));
    },
...
function Toaster($$anchor, $$props) {
  ...
  reset(div);
  template_effect(() => {
    set_class(div, `toaster ${containerClassName() || ""} s-IbbqB-w5zfY5`);
    set_attribute(div, "style", containerStyle());
  });
